...
N.B. Paid versions of UpdraftPlus Backup / Restore have a version number which is 1 higher in the first digit, and has an extra component on the end, but the changelog below still applies. i.e. changes listed for 1.16.24.x of the free version correspond to changes made in 2.16.24.x of the paid version.
...
== Upgrade Notice ==
* 1.16.24: Handle binary data during a backup, improvements to the search and replace code. Various other small tweaks and improvements. A recommended update for all.
